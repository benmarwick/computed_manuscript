...
This manuscript was built at \textbf{14 Jan 2022 16:36:28 PST} using the following computational environment and dependencies:
...
## [17] rticles_0.22.1   rmarkdown_2.11   labeling_0.4.2   bit_4.0.4       
## [21] munsell_0.5.0    broom_0.7.11     compiler_4.1.2   vipor_0.4.5     
...
## [49] generics_0.1.1   vctrs_0.3.8      tools_4.1.2      bit64_4.0.5     
## [53] glue_1.6.0       beeswarm_0.4.0   hms_1.1.1        parallel_4.1.2  
## [57] fastmap_1.1.0    yaml_2.2.1       colorspace_2.0-2 rvest_1.0.2     
## [61] knitr_1.37       haven_2.4.3
\end{verbatim}

The current Git commit details are:

\begin{verbatim}
## [b83d10e] 2022-01-14: Update SN_templates.Rmd
\end{verbatim}
...
\CSLLeftMargin{4. }
\CSLRightInline{Perkel, J. M. Streamline your writing {\textemdash} and collaborations {\textemdash} with these reference managers. \emph{Nature} \textbf{585}, 149--150 (2020).}
